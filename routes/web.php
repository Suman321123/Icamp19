...
//Routes for company
Route::get('/company/login','companyController@getCompanyLoginPage');
...
//Route for Company
Route::group(['middleware'=>['companyCheck','web']],function(){
     Route::get('/company/dashboard','companyController@getCompanyDashboard');
     Route::get('/company/logout','companyController@logout');
     Route::get('/company/downloadResume/{resume}','companyController@downloadResume');
});
